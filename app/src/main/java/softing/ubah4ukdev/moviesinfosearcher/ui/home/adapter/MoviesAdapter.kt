...
v1.0
 */
class MoviesAdapter(movieClickable: IMovieClickable, movieLongClickable: IMovieLongClickable) : RecyclerView.Adapter<MoviesAdapter.ViewHolder?>() {
    ...
    inner class ViewHolder(
        ...
        override fun onClick(v: View) {
            iMovieClickable.onMovieClick(adapterPosition, movies[adapterPosition])
        }

        override fun onLongClick(v: View): Boolean {
            iMovieLongClickable.onMovieLongClick(adapterPosition, movies[adapterPosition])
            return true
        }
